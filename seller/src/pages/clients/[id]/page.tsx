          ...
          <div className='flex flex-col gap-5'>
            <div className='w-full flex gap-5'>
              ...
              <div className='w-full'>
                ...
                <div className='w-full flex justify-between items-center gap-5 bg-cLightGray px-3 py-2 rounded-lg'>
                  <h4 className='font-semibold text-lg text-cDarkBlue'>Фамилия</h4>
                  <p className='text-cDarkBlue text-xl'>{data?.surname}</p>
                </div>
                <div className='w-full flex justify-between items-center gap-5 bg-cLightGray px-3 py-2 rounded-lg'>
                  <h4 className='font-semibold text-lg text-cDarkBlue'>Номер телефона</h4>
                  <p className='text-cDarkBlue text-xl'>{data?.contactInfo}</p>
                </div>
                <div className='w-full flex justify-between items-center gap-5 bg-cLightGray px-3 py-2 rounded-lg'>
                  <h4 className='font-semibold text-lg text-cDarkBlue'>Адрес</h4>
                  <p className='text-cDarkBlue text-xl'>{data?.address}</p>
                </div>
                <div className='w-full flex flex-col justify-center items-start text-left gap-5 bg-cLightGray px-3 py-2 rounded-lg'>
                  <h4 className='font-semibold text-lg text-cDarkBlue'>Дополнительная информация</h4>
