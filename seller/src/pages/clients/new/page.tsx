                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex gap-5">
                    ...
                    <div className="w-full">
                        <div className='w-full flex justify-between items-center gap-5 bg-cLightGray px-3 py-2 rounded-lg'>
                            <label htmlFor='name' className="text-base font-semibold text-cDarkBlue cursor-pointer truncate w-full text-left">Имя</label>
                        ...
                        <div className='w-full flex justify-between items-center gap-5 bg-cLightGray px-3 py-2 rounded-lg'>
                            <label htmlFor='surname' className="text-base font-semibold text-cDarkBlue cursor-pointer truncate w-full text-left">Фамилия</label>
                            <div className='w-full flex justify-end items-center gap-2'>
                        ...
                        <div className='w-full flex justify-between items-center gap-5 bg-cLightGray px-3 py-2 rounded-lg'>
                            <label htmlFor='phoneNumber' className="text-base font-semibold text-cDarkBlue cursor-pointer truncate w-full text-left">Номер телефона</label>
                            <div className='w-full flex justify-end items-center gap-2'>
                        ...
                        <div className='w-full flex justify-between items-center gap-5 bg-cLightGray px-3 py-2 rounded-lg'>
                            <label htmlFor='address' className="text-base font-semibold text-cDarkBlue cursor-pointer truncate w-full text-left">Адрес</label>
                            <div className='w-full flex justify-end items-center gap-2'>
                        ...
                        <div className='w-full flex flex-col justify-start items-start bg-cLightGray px-3 py-2 rounded-lg'>
                            <label htmlFor='note' className="text-base font-semibold text-cDarkBlue cursor-pointer truncate w-full text-left">Дополнительная информация</label>
                            <textarea
                                id='note'
