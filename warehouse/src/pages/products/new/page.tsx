                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex gap-5">
                    ...
                    <div className="w-full">
                        <div className='w-full flex justify-between items-center gap-5 bg-cLightGray px-3 py-2 rounded-lg'>
                            <label htmlFor='name' className="text-base font-semibold text-cDarkBlue cursor-pointer truncate text-left">Наименование</label>
                            <input
                                id='name'
                                type="text"
                        ...
                        <div className='w-full flex justify-between items-center gap-5 bg-cLightGray px-3 py-2 rounded-lg'>
                            <label htmlFor='price' className="text-base font-semibold text-cDarkBlue cursor-pointer truncate text-left">Цена</label>
                            <input
                                id='price'
                                type="text"
                        ...
                        <div className='w-full flex justify-between items-center gap-5 bg-cLightGray px-3 py-2 rounded-lg'>
                            <label htmlFor='amount' className="text-base font-semibold text-cDarkBlue cursor-pointer truncate text-left">Кол-во на складе</label>
                            <input
                                id='amount'
                                type="text"
                        ...
                        <div className='w-full flex justify-between items-center gap-5 bg-cLightGray px-3 py-2 rounded-lg'>
                            <label htmlFor='height' className="text-base font-semibold text-cDarkBlue cursor-pointer truncate text-left">Высота</label>
                            <input
                                id='height'
                                type="text"
                        ...
                        <div className='w-full flex justify-between items-center gap-5 bg-cLightGray px-3 py-2 rounded-lg'>
                            <label htmlFor='width' className="text-base font-semibold text-cDarkBlue cursor-pointer truncate text-left">Ширина</label>
                            <input
                                id='width'
                                type="text"
                        ...
                        <div className='w-full flex justify-between items-center gap-5 bg-cLightGray px-3 py-2 rounded-lg'>
                            <label htmlFor='unit' className="text-base font-semibold text-cDarkBlue cursor-pointer truncate text-left">Единица измерения</label>
                            <select
                                id='unit'
                        ...
                        </div>
                        {
                            loading ? (
                                ...
                                <div className='w-full flex justify-between items-center gap-5 bg-cLightGray px-3 py-2 rounded-lg'>
                                    <label htmlFor='categoryId' className="text-base font-semibold text-cDarkBlue cursor-pointer truncate text-left">Категория</label>
                                    <select
                                        id='categoryId'
